...
export async function Alice(ctcTop, interact) {
  ...
  if (txn2.didTimeout) {
    ...
    stdlib.protect(ctc2, await interact.informTimeout(), {
      ...
      fs: ['at ./index.rsh:38:9:application call to [unknown function] (defined at: ./index.rsh:38:27:function exp)', 'at reach standard library:200:8:application call to "after" (defined at: ./index.rsh:37:28:function exp)', 'at ./index.rsh:55:12:application call to "closeTo" (defined at: reach standard library:195:8:function exp)'],
      msg: 'informTimeout',
      who: 'Alice'
      });
    ...
    while (await (async () => {
      ...
      const v354 = stdlib.protect(ctc0, await interact.random(), {
        ...
        fs: ['at ./index.rsh:65:56:application call to "makeCommitment" (defined at: reach standard library:63:8:function exp)', 'at ./index.rsh:63:15:application call to [unknown function] (defined at: ./index.rsh:63:19:function exp)'],
        msg: 'random',
        who: 'Alice'
        });
      ...
      if (txn4.didTimeout) {
        ...
        stdlib.assert(v440, {
          ...
          fs: ['at ./index.rsh:69:14:application call to "closeTo" (defined at: reach standard library:195:8:function exp)'],
          msg: 'sender correct',
          who: 'Alice'
          });
        ;
        stdlib.protect(ctc2, await interact.informTimeout(), {
          at: './index.rsh:39:29:application',
          fs: ['at ./index.rsh:38:9:application call to [unknown function] (defined at: ./index.rsh:38:27:function exp)', 'at reach standard library:200:8:application call to "after" (defined at: ./index.rsh:37:28:function exp)', 'at ./index.rsh:69:14:application call to "closeTo" (defined at: reach standard library:195:8:function exp)'],
          msg: 'informTimeout',
          who: 'Alice'
          });
        ...
        if (txn5.didTimeout) {
          ...
          stdlib.protect(ctc2, await interact.informTimeout(), {
            at: './index.rsh:39:29:application',
            fs: ['at ./index.rsh:38:9:application call to [unknown function] (defined at: ./index.rsh:38:27:function exp)', 'at reach standard library:200:8:application call to "after" (defined at: ./index.rsh:37:28:function exp)', 'at ./index.rsh:78:14:application call to "closeTo" (defined at: reach standard library:195:8:function exp)'],
            msg: 'informTimeout',
            who: 'Alice'
            });
          ...
          const txn6 = await (ctc.sendrecv({
            ...
            sim_p: (async (txn6) => {
              ...
              ;
              const v396 = stdlib.safeSub(stdlib.checkedBigNumberify('./index.rsh:6:54:decimal', stdlib.UInt_max, '4'), v374);
              const v397 = stdlib.safeAdd(v390, v396);
              const v398 = stdlib.safeMod(v397, stdlib.checkedBigNumberify('./index.rsh:6:70:decimal', stdlib.UInt_max, '3'));
              const cv326 = v398;
              const cv327 = v391;
              const cv334 = v334;
              ...
              await (async () => {
                ...
                if (await (async () => {
                  ...
                  const v456 = stdlib.safeMul(stdlib.checkedBigNumberify('./index.rsh:96:12:decimal', stdlib.UInt_max, '2'), v305);
          ...
          if (txn6.didTimeout) {
            ...
            stdlib.assert(v404, {
              at: 'reach standard library:197:11:dot',
              fs: ['at ./index.rsh:87:14:application call to "closeTo" (defined at: reach standard library:195:8:function exp)'],
              msg: 'sender correct',
              who: 'Alice'
              });
            ;
            stdlib.protect(ctc2, await interact.informTimeout(), {
              at: './index.rsh:39:29:application',
              fs: ['at ./index.rsh:38:9:application call to [unknown function] (defined at: ./index.rsh:38:27:function exp)', 'at reach standard library:200:8:application call to "after" (defined at: ./index.rsh:37:28:function exp)', 'at ./index.rsh:87:14:application call to "closeTo" (defined at: reach standard library:195:8:function exp)'],
              msg: 'informTimeout',
              who: 'Alice'
              });
    ...
    stdlib.protect(ctc2, await interact.seeOutcome(v326), {
      at: './index.rsh:100:24:application',
      fs: ['at ./index.rsh:99:7:application call to [unknown function] (defined at: ./index.rsh:99:25:function exp)'],
      msg: 'seeOutcome',
      who: 'Alice'
      });
...
export const _stateSourceMap = {
  ...
  2: {
    ...
    fs: ['at ./index.rsh:55:12:application call to "closeTo" (defined at: reach standard library:195:8:function exp)'],
    msg: null,
    who: 'Module'
    },
  4: {
