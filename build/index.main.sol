...
contract ReachContract is Stdlib {
  ...
  function _reachi_0(T0 memory _a, Memory memory _Memory) internal  {
    ...
    reachRequire((((_a.elem0) == uint256(0)) || (current_time == (_a.elem0))), uint256(8) /*'time check at ./index.rsh:48:9:dot'*/);
    reachRequire((msg.value == (_a.elem1)), uint256(9) /*'(./index.rsh:48:9:dot,[],"verify network token pay amount")'*/);
    T1 memory nsvs;
  ...
  function _reachi_1(T2 memory _a, Memory memory _Memory) internal  {
    reachRequire((current_step == uint256(1)), uint256(10) /*'state check at ./index.rsh:54:7:dot'*/);
    (T1 memory _svs) = abi.decode(current_svbs, (T1));
    reachRequire((! locked), uint256(11) /*'locked'*/);
    emit _reach_e1(msg.sender, _a);
    reachRequire((((_a.elem0) == uint256(0)) || (current_time == (_a.elem0))), uint256(12) /*'time check at ./index.rsh:54:7:dot'*/);
    reachRequire((uint256(block.number) < _svs.v317), uint256(13) /*'timeout check at ./index.rsh:54:7:dot'*/);
    reachRequire((msg.value == _svs.v305), uint256(14) /*'(./index.rsh:54:7:dot,[],"verify network token pay amount")'*/);
    T3  memory _ja;
    _ja.elem0 = _svs.v304;
    _ja.elem1 = _svs.v305;
    _ja.elem2 = _svs.v306;
  ...
  function _reachi_2(T2 memory _a, Memory memory _Memory) internal  {
    ...
    reachRequire((msg.value == uint256(0)), uint256(19) /*'(reach standard library:197:11:dot,[at ./index.rsh:55:12:application call to "closeTo" (defined at: reach standard library:195:8:function exp)],"verify network token pay amount")'*/);
  ...
  function _reachi_4(T4 memory _a, Memory memory _Memory) internal  {
    reachRequire((current_step == uint256(5)), uint256(20) /*'state check at ./index.rsh:68:11:dot'*/);
    (T5 memory _svs) = abi.decode(current_svbs, (T5));
    reachRequire((! locked), uint256(21) /*'locked'*/);
    emit _reach_e4(msg.sender, _a);
    reachRequire((((_a.elem0) == uint256(0)) || (current_time == (_a.elem0))), uint256(22) /*'time check at ./index.rsh:68:11:dot'*/);
    reachRequire((uint256(block.number) < _svs.v349), uint256(23) /*'timeout check at ./index.rsh:68:11:dot'*/);
    reachRequire((msg.value == uint256(0)), uint256(24) /*'(./index.rsh:68:11:dot,[],"verify network token pay amount")'*/);
    reachRequire(((_svs.v304 == payable(msg.sender))), uint256(25) /*'(./index.rsh:68:11:dot,[],Just "sender correct")'*/);
    T6 memory nsvs;
    nsvs.v304 = _svs.v304;
    nsvs.v305 = _svs.v305;
    nsvs.v306 = _svs.v306;
  ...
  function _reachi_5(T2 memory _a, Memory memory _Memory) internal  {
    ...
    reachRequire((msg.value == uint256(0)), uint256(30) /*'(reach standard library:197:11:dot,[at ./index.rsh:69:14:application call to "closeTo" (defined at: reach standard library:195:8:function exp)],"verify network token pay amount")'*/);
    reachRequire((((_svs.v304 == payable(msg.sender)) ? true : (_svs.v321 == payable(msg.sender)))), uint256(31) /*'(reach standard library:197:11:dot,[at ./index.rsh:69:14:application call to "closeTo" (defined at: reach standard library:195:8:function exp)],Just "sender correct")'*/);
  ...
  function _reachi_7(T2 memory _a, Memory memory _Memory) internal  {
    ...
    reachRequire((msg.value == uint256(0)), uint256(42) /*'(reach standard library:197:11:dot,[at ./index.rsh:78:14:application call to "closeTo" (defined at: reach standard library:195:8:function exp)],"verify network token pay amount")'*/);
    reachRequire((((_svs.v304 == payable(msg.sender)) ? true : (_svs.v321 == payable(msg.sender)))), uint256(43) /*'(reach standard library:197:11:dot,[at ./index.rsh:78:14:application call to "closeTo" (defined at: reach standard library:195:8:function exp)],Just "sender correct")'*/);
  ...
  function _reachi_8(T0 memory _a, Memory memory _Memory) internal  {
    reachRequire((current_step == uint256(9)), uint256(44) /*'state check at ./index.rsh:86:11:dot'*/);
    (T8 memory _svs) = abi.decode(current_svbs, (T8));
    reachRequire((! locked), uint256(45) /*'locked'*/);
    emit _reach_e8(msg.sender, _a);
    reachRequire((((_a.elem0) == uint256(0)) || (current_time == (_a.elem0))), uint256(46) /*'time check at ./index.rsh:86:11:dot'*/);
    reachRequire((uint256(block.number) < _svs.v384), uint256(47) /*'timeout check at ./index.rsh:86:11:dot'*/);
    reachRequire((msg.value == uint256(0)), uint256(48) /*'(./index.rsh:86:11:dot,[],"verify network token pay amount")'*/);
    reachRequire(((_svs.v304 == payable(msg.sender))), uint256(49) /*'(./index.rsh:86:11:dot,[],Just "sender correct")'*/);
    reachRequire(((_svs.v358 == (uint256(keccak256(abi.encode((_a.elem1), (_a.elem2))))))), uint256(50) /*'(reach standard library:69:17:application,[at ./index.rsh:89:20:application call to "checkCommitment" (defined at: reach standard library:68:8:function exp)],Nothing)'*/);
    T3  memory _ja;
    _ja.elem0 = _svs.v304;
    _ja.elem1 = _svs.v305;
    _ja.elem2 = _svs.v306;
  ...
  function _reachi_9(T2 memory _a, Memory memory _Memory) internal  {
    ...
    reachRequire((msg.value == uint256(0)), uint256(55) /*'(reach standard library:197:11:dot,[at ./index.rsh:87:14:application call to "closeTo" (defined at: reach standard library:195:8:function exp)],"verify network token pay amount")'*/);
    reachRequire((((_svs.v304 == payable(msg.sender)) ? true : (_svs.v321 == payable(msg.sender)))), uint256(56) /*'(reach standard library:197:11:dot,[at ./index.rsh:87:14:application call to "closeTo" (defined at: reach standard library:195:8:function exp)],Just "sender correct")'*/);
    _svs.v321.transfer(_svs.v334);
    current_step = 0x0;
    current_time = 0x0;
    delete current_svbs;
